...
f.assign(project(Ellipse(a=3, b=1.2, Q= Q, degree=0), W0))
...
fig.suptitle("Objective and Shape Gradient Norms over Iterations (Log Scale)")
fig.tight_layout()
...
fig_lin.suptitle("Objective and Shape Gradient Norms over Iterations (Linear Scale)")
...
plt.legend()
plt.title("Relative Change in Objective over Iterations")
...
plt.xlabel("Iteration")
plt.legend()
plt.title("Objective Components over Iterations")
...
plt.xlabel("Iteration")
plt.legend()
plt.title("Objective Components over Iterations (Log Scale)")
