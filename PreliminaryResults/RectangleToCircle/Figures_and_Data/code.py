...
if not subdomainlist:
    ...
    # objective_main = ((dot(q_ - q_target, q_ - q_target)) + (q_[1]-q_target[1])*(q_[1]-q_target[1]) + (q_[2]-q_target[2])*(q_[2]-q_target[2]) + (q_[4]-q_target[4])*(q_[4]-q_target[4]) + (q_[0]+ q_[3]-q_target[0]-q_target[3])*(q_[0]+ q_[3]-q_target[0]-q_target[3]))/(assemble(1*dx))*dx
else:
    # objective_main = (dot(q_ - q_target, q_ - q_target))/(assemble(1*dx(subdomainlist[0])))*dx(subdomainlist[0])
    objective_main = ((dot(q_ - q_target, q_ - q_target)) + (q_[1]-q_target[1])*(q_[1]-q_target[1]) + (q_[2]-q_target[2])*(q_[2]-q_target[2]) + (q_[4]-q_target[4])*(q_[4]-q_target[4]) + (q_[0]+ q_[3]-q_target[0]-q_target[3])*(q_[0]+ q_[3]-q_target[0]-q_target[3]))/(assemble(1*dx(subdomainlist[0])))*dx(subdomainlist[0])
